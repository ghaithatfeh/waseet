                                ...
                                <div class="col-12   border-0  px-0">
                                    <div class="col-12 px-0 pb-5 " id="right-search-section">
                                        ...
                                        <div class="control-group py-2 px-2 ">
                                            <label class="control control-checkbox pb-2">
                                                ...
                                                <label class="kufi font-1 d-inline " for="business"
                                                    style="cursor: pointer;color: var(--bg-font-4)">أعمال
                                                    وخدمات استشارية وإدارية </label>
                                            ...
                                            <label class="control control-checkbox pb-2">
                                                ...
                                                <label class="kufi font-1 d-inline " for="development"
                                                    style="cursor: pointer;color: var(--bg-font-4)">برمجة،
                                                    تطوير المواقع والتطبيقات </label>
                                            ...
                                            <label class="control control-checkbox pb-2">
                                                ...
                                                <label class="kufi font-1 d-inline " for="design"
                                                    style="cursor: pointer;color: var(--bg-font-4)">تصميم
                                                    وأعمال فنية وإبداعية </label>
                                            ...
                                            <label class="control control-checkbox pb-2">
                                                ...
                                                <label class="kufi font-1 d-inline " for="marketing"
                                                    style="cursor: pointer;color: var(--bg-font-4)">تسويق
                                                    الكتروني ومبيعات </label>
                                            ...
                                            <label class="control control-checkbox pb-2">
                                                ...
                                                <label class="kufi font-1 d-inline " for="writing-translation"
                                                    style="cursor: pointer;color: var(--bg-font-4)">كتابة،
                                                    صناعة محتوى، ترجمة ولغات </label>
                                            ...
                                            <label class="control control-checkbox pb-2">
                                                ...
                                                <label class="kufi font-1 d-inline " for="training"
                                                    style="cursor: pointer;color: var(--bg-font-4)">تدريب،
                                                    تعليم ومساعدة عن بعد </label>
                                            ...
                                            <label class="control control-checkbox pb-2">
                                                ...
                                                <label class="kufi font-1 d-inline " for="other"
                                                    style="cursor: pointer;color: var(--bg-font-4)">أمور
                                                    أخرى </label>
                                        ...
                                        <div style="" dir="ltr"
                                            ...
                                            style="direction: ltr">
                                            <input type="" name="" class="js-range-slider nafezly-transition pricing"
                                                style="opacity: 0" data-filter="pricing">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="col-12 p-0 row d-flex ">
                                                    <div class="col-12 col-lg-9 p-0">
                                                        <h2 style="font-size:16px;height: 23px;"
                                                            ...
                                                            <a href="/project" style="color: var(--bg-color-3);"
                                                                class="text-truncate">
                                                                مطلوب برمجة تتصل ببرنامج سطح مكتب بلغة السي
                                                                شارب</a>
                                                        </h2>
                                                        <div class="col-12 py-2 px-0">
                                                            <h3 class="naskh font-1 m-0 col-12 col-lg-10 px-0"
                                                                ...
                                                                لدي نظام محاسبي يعمل على سطح المكتب بلغة
                                                                السي شارب ,
                                                                واريد طريقة يمكن للزبناء الاتصال بالبرنامج
                                                                عن بعد من هواتفهم في حالة كان الكمبيوتر
                                                                البعيد متصل بالانترنت .
                                                                ماهي الطريقة الافضل لذلك ؟...</h3>
                                                        </div>
                                                        <div class="col-12 px-0 row align-items-center justify-content-between text-truncate mb-2 mb-lg-0 d-lg-flex d-none"
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <a href="https://nafezly.com/u/oulka11"
                                            ...
                                            <div class="col-12 pb-1 pt-2">
                                                <nav>
                                                    <ul class="pagination">
                                                        ...
                                                        <li class="page-item">
                                                            <a class="page-link"
                                                                href="https://nafezly.com/projects?page=2" rel="next">التالي
                                                                &raquo;</a>
                                                        </li>
                                                    </ul>
                                                </nav>
