                                                    ...
                                                    <div class="p-0 d-inline-block mr-auto" style="white-space: nowrap;">
                                                        <div class="col-12 px-1 d-flex align-items-center">
                                                            <span class="d-inline-block pt-2 ml-1"
                                                                ...
                                                                id="counter_629508cd795c6">
                                                                2
                                                            </span>
                                                            <span class="d-inline-block love-favourite-area noselect  "
                                                                style=" cursor: pointer;" data-id="629508cd795c6"
                                                                data-type="service" data-type_id="223"
                                                                id="love_id_629508cd795c6">
                                                                <span class="fa-heart love-favourite fal font-3"
                                                                    style=" padding: 7px 6px 4px 6px; border-radius: 50%!important;color: #2196f3 ;"
                                                                    id="icon_629508cd795c6"></span>
                                                            </span>
                                                            <div class="dropdown show d-none dots-629508cd795c6 ">
                                                                <span
                                                                ...
                                                                <div class="dropdown-menu border"
                                                                    ...
                                                                    <a class="dropdown-item font-md-1 pr-2 hover-darker pl-3 report-nafezly "
                                                                        ...
                                                                        data-type="service" data-type_id="223"><span
                        ...
                        <div class=" col-12 col-lg-8 order-lg-1 order-3 px-0 px-lg-4 pb-lg-4 pt-0">
                            <div class="col-12 px-0 py-1 py-lg-3">
                                <div class="col-12 px-0 main-nafez-box-styles" style="overflow: hidden;">
                                    ...
                                    <div class="col-12  "
                                        style="border-top:1px solid var(--bg-main-bg);padding: 20px;">
                                            ...
                                            <div class="col-12 row px-0 main-nafez-box-styles ">
                                                ...
                                                <div class="col-12 row p-3">
                                                    ...
                                                    <div class="col-12 px-2">
                                                        <span class="px-1 "
                                                            style="padding:4px 5px;font-size:12px">بائع الخدمة</span>
                                                    </div>
