        ...
        @if ($paginator->onFirstPage())
            <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                <span class="page-link" aria-hidden="true">
                    <span class="d-none d-md-block">&laquo; السابق</span>
                    <span class="d-block d-md-none">السابق</span>
                </span>
            </li>
        @else
            <li class="page-item">
        ...
        @if ($paginator->hasMorePages())
            <li class="page-item">
                <button type="button" class="page-link" wire:click="nextPage" rel="next"
                    ...
                    <span class="d-block d-md-none">التالي</span>
                    <span class="d-none d-md-block">التالي &raquo;</span>
                </button>
            </li>
        @else
