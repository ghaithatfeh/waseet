        ...
        .dash-list-area .active span {
            color: var(--bg-second-bg) !important;
                    ...
                    <div class="col-12  col-lg-9 col-md-8 text-center  content-area  px-0 px-md-3 pb-2">
                        <form method="POST" action="https://nafezly.com/profile/personal_data_update"
                                                ...
                                                <ul class="navbar-nav mr-auto pr-0">
                                                    <li class="nav-item">
                                                        <a class="nav-link font-1 py-3 px-3 d-inline-block "
                                                            href="https://nafezly.com/profile/personal-data"
                                                            style="color: var(--bg-color-0); border-bottom: 3px solid #000">البيانات
                                                            الشخصية</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link font-1 py-3 px-3 d-inline-block "
                                                            href="https://nafezly.com/profile/nafezly-settings"
                                        ...
                                        <div class="col-12 col-md-12 mb-4 py-4 row text-center row">
                                            <div class="col-12 col-md-3 text-center mb-5">
                                                <div class="text-center"
                                                    style="height: 130px;width: 130px;border-radius: 50%!important;background-image: url('https://nafezly-production.s3.eu-west-3.amazonaws.com/uploads/avatars/24414_1653664595_6290eb5310a48.jpg'); background-size: cover; background-position: center;display: inline-block;cursor: pointer;position: relative;"
                                                    id="pf_foto">
                                                    ...
                                                    <input type="file" name="" id="profile_image"
                                                ...
                                                <div class="col-12 mb-4">
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        <input type="" name="firstname" class="form-control"
                                                            minlength="2" maxlenght="30" required="" value="Ghaith">
                                                    </div>
                                                </div>
                                                <div class="col-12 mb-4">
                                                    <div class="col-12 font-1">
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        <input type="" name="lastname" class="form-control" minlength="2"
                                                            maxlenght="30" required="" value="Atfeh">
                                                    </div>
                                                </div>
                                                <div class="col-12 mb-4">
                                                    <div class="col-12 font-1">
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        <input type="" name="phone" class="form-control" minlength="10"
                                                            minlength="30" value="0938914469" readonly="" disabled="">
                                                    </div>
                                                </div>
